...
public class Phone {
	...
	public void showPhoneInfo() {
		System.out.println("휴대폰타입: "+(phoneType == 1 ? "feature-phone" : "smart-phone"));
		System.out.println("휴대폰모델: "+phoneModel);
		System.out.println("휴대폰색상: "+(phoneColor == 1 ? "블랙" : phoneColor ==2 ? "화이트" : phoneColor ==3 ? "블루" : "레드"));
	}
}
